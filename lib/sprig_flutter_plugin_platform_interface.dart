...
abstract class SprigFlutterPluginPlatform extends PlatformInterface {
  ...
  static SprigFlutterPluginPlatform _instance =
      MethodChannelSprigFlutterPlugin();
  ...
  Future<String?> visitorIdentifierString() {
    throw UnimplementedError(
      'visitorIdentifierString() has not been implemented.',
    );
  }
  ...
  Future<void> setVisitorAttributesAndIdentify({
    ...
    throw UnimplementedError(
      'setVisitorAttributesAndIdentify() has not been implemented.',
    );
  }
  ...
  Future<void> removeVisitorAttributes({
    ...
    throw UnimplementedError(
      'removeVisitorAttributes() has not been implemented.',
    );
  }
  ...
  Future<void> trackIdentifyAndPresent({
    ...
    throw UnimplementedError(
      'trackIdentifyAndPresent() has not been implemented.',
    );
  }
